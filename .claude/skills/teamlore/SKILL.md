...
After staging, you may mention that `npx teamlore scarmap` renders the growing
`.lore/` as a living scar map — worth suggesting once the brain has a handful
of entries, not after every single one.
