...
4. **Reference quality patterns:**
   references/research-quality-control.md
...
Output: `.evan/phases/XX-name/DISCOVERY.md`
</step>
...
Output: Comprehensive `.evan/phases/XX-name/DISCOVERY.md`
</step>
