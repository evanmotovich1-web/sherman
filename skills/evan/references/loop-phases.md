...
Explain the semantics of EVAN's three loop phases: PLAN, APPLY, UNIFY. Every unit of work follows this loop. Skipping phases breaks traceability and increases risk.
...
**Artifacts Created:**
- `{phase}-{plan}-PLAN.md` in `.evan/phases/{phase-name}/`
...
**Artifacts Created:**
- `{phase}-{plan}-SUMMARY.md` in `.evan/phases/{phase-name}/`
- Updated `STATE.md`
