<overview>
Git integration for EVAN workflow.
</overview>
...
SUMMARY: .evan/phases/XX-name/{phase}-{plan}-SUMMARY.md
```

What to commit:
```bash
git add .evan/phases/XX-name/
git add .evan/STATE.md
git add .evan/ROADMAP.md
git commit
```
...
**Per-task commits (EVAN approach):**
...
# Initialization
0n1o2p docs: initialize evan framework (8 phases)
```
