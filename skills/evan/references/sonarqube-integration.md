...
Reference for integrating SonarQube code quality scanning with EVAN.
...
## Integration with EVAN

### CONCERNS.md Auto-Population

The quality-gate workflow updates `.evan/codebase/CONCERNS.md`:
