...
Template for `.evan/MILESTONE-CONTEXT.md` — temporary handoff from discuss-milestone to create-milestone.
...
**Generated:** {{DATE}}
**Status:** Ready for /evan create-milestone
...
*This file is temporary. It will be deleted after /evan create-milestone creates the milestone.*
...
## Integration with EVAN Workflow
...
**Estimated phases:** 3
**Focus:** Complete milestone management tooling for EVAN framework
