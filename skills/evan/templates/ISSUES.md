...
Template for `.evan/ISSUES.md` — deferred enhancements discovered during execution.
...
**Location:** `.evan/ISSUES.md` (project-level, not phase-level)
...
2. Log to `.evan/ISSUES.md` with ISS-NNN format
