...
Template for `.evan/phases/{phase-number}-{name}/{phase}-{plan}-PLAN.md` - executable phase plans.
...
<!-- If .evan/SPECIAL-FLOWS.md exists, this section is auto-populated by /evan plan -->
...
<output>
After completion, create `.evan/phases/XX-name/{phase}-{plan}-SUMMARY.md`
</output>
```
