...
Template for `.evan/phases/{NN}-{name}/CONTEXT.md` - phase discussion context handoff.

**Purpose:** Captures user's vision, goals, and approach before planning. Created by `/evan discuss`, consumed by `/evan plan`.
...
*Created by /evan discuss, consumed by /evan plan.*
```
