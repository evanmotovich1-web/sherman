...
Template for `.evan/MILESTONES.md` — the project's milestone log.
...
```markdown
# Project Milestones: EVAN Framework
...
**Delivered:** EVAN framework foundation with Plan-Apply-Unify loop
...
- CARL EVAN domain with 11 rules
