...
Template for `.evan/research/{topic-slug}.md` - research findings from subagent discovery.

**Purpose:** Captures research findings for main session review. Created by `/evan research` or `/evan research-phase`.
...
*Created by /evan research. Review before integrating.*
...
1. User runs `/evan research <topic>`
