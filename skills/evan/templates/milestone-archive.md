...
Template for milestone archives at `.evan/milestones/v{VERSION}-{NAME}.md`.
...
**Pattern:** `.evan/milestones/v{VERSION}-{NAME}.md`
...
**Reason:** Improve agent context for EVAN projects
