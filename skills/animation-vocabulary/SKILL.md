...
category: design
summary: reverse-lookup motion vocabulary and implementation patterns
description: Translate vague animation descriptions into precise motion vocabulary and implementation patterns. Use when a motion idea is hard to name or specify.
---
...
_A curated snapshot of the motion vocabulary; keep implementations aligned with it._
