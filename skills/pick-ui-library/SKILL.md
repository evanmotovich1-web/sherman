...
category: design
summary: choose the right UI library from product constraints
description: Choose an appropriate UI library from real product and implementation constraints. Use before adding a component, animation, or design-system dependency.
---
