...
category: documents
summary: profile, analyze, and verify spreadsheet data while preserving formulas and source files
...
Sherman boundary: the no-PHI rule governs this skill absolutely — never process patient-identifying documents, spreadsheets, or records with it. See phi-boundary. Work with the format, never the patient.
