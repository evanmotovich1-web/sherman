...
category: design
summary: review animation code against a high-craft motion bar
description: Review animation and motion code against a high-craft standard and return evidence-backed issues. Use for animation code review or motion QA.
---
...
3. **Fix the easing** — swap `ease-in` for `ease-out` or a custom curve; use a strong cubic-bezier.
